...
const AdminClubManagement = () => {
  ...
  const handleCreateClub = async (e) => {
    ...
    try {
      ...
      setFormData({ name: "", description: "", faculty_coordinator: null, established_date: "" });
            ...
            >
              ...
              {mentors.map((mentor) => (
                <option key={mentor.id} value={mentor.id}>
                  {mentor.user_details?.first_name} {mentor.user_details?.last_name}
                </option>
              ))}
            </select>
        ...
        {clubs.map((club) => (
          <div key={club.id} className="bg-white p-6 rounded-lg shadow">
            ...
            <div className="space-y-3">
              <div>
                <label className="text-sm font-medium text-gray-700">Faculty Coordinator</label>
                <select
              ...
              <div>
                <label className="text-sm font-medium text-gray-700">Club Head</label>
                <select

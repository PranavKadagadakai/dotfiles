...
const AdminAICTEConfig = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const payload = {
        ...
        min_points_required: formData.min_points_required ? parseInt(formData.min_points_required) : null,
        max_points_allowed: formData.max_points_allowed ? parseInt(formData.max_points_allowed) : null,
      };
      ...
      setFormData({ name: "", description: "", min_points_required: "", max_points_allowed: "" });
  ...
  if (loading) return <div className="text-center py-10">Loading AICTE categories...</div>;
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <input
                ...
                onChange={(e) =>
                  setFormData({ ...formData, min_points_required: e.target.value })
                }
              ...
              <input
                ...
                onChange={(e) =>
                  setFormData({ ...formData, max_points_allowed: e.target.value })
                }
                className="px-4 py-2 border rounded-lg"
              />
            </div>
        ...
        <table className="w-full">
          <thead className="bg-gray-100 border-b">
            <tr>
              ...
              <th className="px-6 py-3 text-left text-sm font-bold">Min Points</th>
              <th className="px-6 py-3 text-left text-sm font-bold">Max Points</th>
          ...
          <tbody>
            {categories.map((category) => (
              <tr key={category.id} className="border-b hover:bg-gray-50">
                ...
                <td className="px-6 py-3">{category.min_points_required || "—"}</td>
                <td className="px-6 py-3">{category.max_points_allowed || "—"}</td>

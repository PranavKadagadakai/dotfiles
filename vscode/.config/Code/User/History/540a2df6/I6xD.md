...
- [ ] Full student registration → profile creation → update → completion
- [ ] Full mentor registration → profile creation → update → completion
- [ ] Full club organizer registration → profile creation → update → completion
...
A: Green banner at top of profile page with checkmark: "✓ Your profile is complete!"

...
- View own certificates and points
- Update own profile
...
- **Acceptance Criteria:**
  ...
  - USN/Employee ID must be unique
...
- **Priority:** Medium
- **Description:** Users shall update personal information and preferences
- **Input:** Profile fields (name, contact, department, semester, etc.)
- **Processing:** Validate data, update database, log changes
...
- **Priority:** High
- **Description:** Administrators shall assign and modify user roles
- **Input:** User ID, role assignment, effective date
- **Processing:** Validate permissions, update role, log assignment
- **Output:** Role updated, notification sent to user
- **Acceptance Criteria:**
  - Only admins can assign roles
  - Role changes logged in audit trail
  - User notified within 5 minutes of role change
...
- **Priority:** High
- **Description:** System shall maintain one global certificate template (admin-only).
- **Input:** Template name, HTML/CSS design, placeholder variables, background image
- **Processing:** Validate template, store design, generate preview
- **Output:** Template saved, preview generated
- **Acceptance Criteria:**
  - WYSIWYG editor with drag-drop elements
  - Supported variables: {student_name}, {event_name}, {date}, {points}, {usn}
  - Template preview in real-time
  - Multiple templates per club
  - A4 size PDF output (210mm × 297mm)

**FR-CG-002: Bulk Certificate Generation**

- **Priority:** High
- **Description:** System shall generate certificates upon event completion
- **Input:** Event ID, attendance list, template selection
- **Processing:** Merge data with template, generate PDFs, embed QR codes, store files
- **Output:** Individual PDF certificates for each attendee
- **Acceptance Criteria:**
  - Certificates generated within 5 minutes of event completion
  - Unique QR code per certificate for verification
...
_Version 2.0 - November 16, 2025_

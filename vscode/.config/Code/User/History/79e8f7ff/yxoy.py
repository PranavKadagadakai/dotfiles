...
def validate_usn_format(usn, department):
    ...
    if not match:
        return False, "Invalid USN format. Expected format: 2GI22XX001 or 2GI22XXL001 where XX is branch code", None
    ...
    # Determine admission type based on USN format
    admission_type = 'lateral' if has_lateral == 'L' else 'regular'

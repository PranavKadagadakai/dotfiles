...
class HallBooking(models.Model):
    ...
    event = models.ForeignKey('Event', on_delete=models.CASCADE, related_name='hall_bookings', help_text="Event for which the hall is being booked.")
...
class Event(models.Model):
    ...
    end_date = models.DateField(blank=True, null=True, help_text="End date for multi-day events. If blank, same as event_date.")
    start_time = models.TimeField()
    end_time = models.TimeField(blank=True, null=True)
    max_participants = models.IntegerField(blank=True, null=True)
    aicte_activity_points = models.IntegerField(blank=True, null=True, help_text="Activity points allocated for participating in this event.")
    aicte_category = models.ForeignKey(AICTECategory, on_delete=models.SET_NULL, null=True, blank=True, related_name='events', help_text="AICTE category for this event's points.")

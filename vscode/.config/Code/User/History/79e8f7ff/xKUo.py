...
class Certificate(models.Model):
    ...
    # Use FileField so Django stores file under MEDIA_ROOT using storage backend.
    # upload_to is the helper above (relative to MEDIA_ROOT).
    file = models.FileField(upload_to=certificate_file_path, max_length=500, blank=True, null=True)

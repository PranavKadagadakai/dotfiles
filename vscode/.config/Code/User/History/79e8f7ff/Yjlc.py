...
class Mentor(models.Model):
    ...
    department = models.CharField(max_length=100, default="General")
    designation = models.CharField(max_length=100, default="Mentor")
...
class Hall(models.Model):
    ...
    location = models.CharField(max_length=200, blank=True, default="Campus")
...
class Event(models.Model):
    ...
    max_participants = models.IntegerField(blank=True, null=True, default=100)
...
class AICTECategory(models.Model):
    name = models.CharField(max_length=100, unique=True)
    description = models.TextField(blank=True)
    min_points_required = models.IntegerField(blank=True, null=True, default=0)
    max_points_allowed = models.IntegerField(blank=True, null=True, default=100)

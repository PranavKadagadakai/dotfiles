    ...
    <div className="min-h-screen bg-gray-100">
      ...
      <div className="bg-white shadow-md">
        <div className="max-w-7xl mx-auto px-6 py-6">
          ...
          <p className="text-gray-600 mt-2">Manage users, clubs, events, and system settings</p>
        </div>
      </div>
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                <div className="bg-white p-6 rounded-lg shadow hover:shadow-lg transition">
                  ...
                  <div className="text-3xl font-bold text-blue-600 mt-2">{stats.total_users}</div>
                </div>
                <div className="bg-white p-6 rounded-lg shadow hover:shadow-lg transition">
                  <div className="text-gray-600 text-sm font-medium">Total Students</div>
                  <div className="text-3xl font-bold text-green-600 mt-2">{stats.total_students}</div>
                </div>
                <div className="bg-white p-6 rounded-lg shadow hover:shadow-lg transition">
                  <div className="text-gray-600 text-sm font-medium">Total Mentors</div>
                  <div className="text-3xl font-bold text-purple-600 mt-2">{stats.total_mentors}</div>
                </div>
                <div className="bg-white p-6 rounded-lg shadow hover:shadow-lg transition">
                  <div className="text-gray-600 text-sm font-medium">Total Clubs</div>
                  <div className="text-3xl font-bold text-orange-600 mt-2">{stats.total_clubs}</div>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
                <div className="bg-white p-6 rounded-lg shadow">
                  ...
                  <div className="text-3xl font-bold text-indigo-600 mt-2">{stats.total_events}</div>
                </div>
                <div className="bg-white p-6 rounded-lg shadow">
                ...
                <div className="bg-white p-6 rounded-lg shadow">
                  ...
                  <div className="text-3xl font-bold text-pink-600 mt-2">{stats.active_bookings}</div>
                </div>
              </div>
            </div>
          )}

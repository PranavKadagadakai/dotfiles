        ...
        with transaction.atomic():
            for item in attendance_items:
                ...
                if is_present and event.aicte_category and event.points_awarded > 0:
                    ...
                    aicte_transaction, created = AICTEPointTransaction.objects.get_or_create(
                        student=student,
                        event=event,
                        defaults={
    ...
    def generate_certificates(self, request, pk=None):
        ...
        for attendance in attendees:
            ...
            try:
                ...
                code = aicte_transaction.verification_code if aicte_transaction and aicte_transaction.verification_code else 'N/A'

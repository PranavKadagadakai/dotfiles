...
from .serializers import (
    ...
    PrincipalSignatureSerializer, UserNotificationPreferencesSerializer
)
...
class UserNotificationPreferencesViewSet(viewsets.ModelViewSet):
    ...
    def perform_create(self, serializer):
        # Ensure only one preferences record per user (UPSERT)
        instance, created = UserNotificationPreferences.objects.get_or_create(
            user=self.request.user,
    ...
    def update(self, request, *args, **kwargs):
        # For PUT/PATCH, we want to update existing or create if none exists

...
class EventViewSet(viewsets.ModelViewSet):
    ...
    def generate_certificates(self, request, pk=None):
        ...
        for attendance in attendees:
            ...
            try:
                # Gto crecrtaee certificate record
                ...
                #AAlways wagenerys ee certifica to reptaco old ones if they exist
            # DeleDelo f oldifile f  ie xxists
i               sfc.fil:
                if ccifc.fil.dle(sv=Fls                    certificate.file.delete(save=False)
                    certificate.file_hash = None  # Clear hash so it's recalculated

  ...
  const handleApproval = async (
    ...
    try {
      ...
      if (statusAction === "reject") {
        data.reason = prompt("Enter rejection reason:");
    ...
    <div className="p-6 bg-gray-100 min-h-screen">
            ...
            {mentees.map((mentee) => (
              ...
              >
                <div className="font-medium">
                  {mentee.user?.first_name || mentee.first_name}{" "}
                  {mentee.user?.last_name || mentee.last_name}
                </div>
          ...
          {selectedMentee ? (
            <div>
              <h2 className="text-xl font-semibold mb-4">
                {selectedMentee.user?.first_name || selectedMentee.first_name}{" "}
                {selectedMentee.user?.last_name || selectedMentee.last_name} -
                Stats
              </h2>
              {menteeStats ? (
      ...
      {approvalModal.open && (
        <ApprovalModal
          ...
          onReject={() =>
            handleApproval(approvalModal.transaction.id, "reject")
          }

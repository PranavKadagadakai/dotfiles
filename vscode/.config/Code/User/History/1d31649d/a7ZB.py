...
INSTALLED_APPS = [
    ...
    'apps.aicte_points.apps.AictePointsConfig',
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('DB_NAME', 'certifytrack'),
...
DEFAULT_FROM_EMAIL = os.environ.get('DEFAULT_FROM_EMAIL', 'noreply@certifytrack.com')

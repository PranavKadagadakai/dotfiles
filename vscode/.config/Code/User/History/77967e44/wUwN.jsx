...
function ProfilePage() {
  ...
  const handlePhotoChange = async (e) => {
    ...
    if (validation.warnings.length > 0) {
      ...
      // Could show these warnings to the user if desired
    }
    ...
    // Clear any previous errors related to file upload
    setError("");
  };
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        ...
        {/* Notification Preferences - Temporarily commented out due to backend endpoint missing */}

...
function ProfilePage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.log("[ProfilePage] Starting profile update submission");
      ...
      Object.keys(formData).forEach((key) => {
        ...
        if (key !== "profile_photo") {
          if (value !== null && value !== undefined && value !== "") {
            ...
            console.log(`[ProfilePage] Added field '${key}': ${value}`);
          } else {
            console.log(`[ProfilePage] Skipped field '${key}': ${value}`);
          }
        }
      });
      ...
      if (profilePhoto instanceof File) {
        ...
        console.log(
          `[ProfilePage] Added profile_photo: ${profilePhoto.name} (${profilePhoto.size} bytes)`
        );
      } else {
      ...
      console.log("[ProfilePage] Response received:", response.data);

...
const ClubHeadDashboard = () => {
  ...
  const fetchClubs = async () => {
    try {
      ...
      console.log("All Clubs Response:", clubsData);

      const clubsData = response.data.results || response.data || [];
      console.log("All Clubs Response:", clubsData);
clubDataparseInt()parseInt()
      // Filter clubs where current user is club head
      const userCluFiltered bs =
        clubsData.filter((club) => parseInt(club.club_head) === parseInt(getCurrentUserId())) || [];
      ...
      if (userClubs.length > 0) {
        ...
        console.log("Selected Club:", userClubs[0]);
      }

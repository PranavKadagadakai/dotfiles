  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      const dashboardMap = {
        ...
        club_organizer: '/dashboard/club',
        admin: '/dashboard/admin',
      };

      navigate(dashboardMap[user.user_type] || '/dashboard');
    } catch (err) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-r from-blue-500 to-purple-600 flex items-center justify-center p-4">
      <div className="bg-white rounded-lg shadow-xl w-full max-w-md p-8">
        <h1 className="text-3xl font-bold text-center mb-2 text-gray-800">CertifyTrack</h1>
        <p className="text-center text-gray-600 mb-6">Unified Platform for Events & Certificates</p>

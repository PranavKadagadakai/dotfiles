              ...
              >
                ...
                <div className="flex gap-2">
                  <button
                    ...
                    disabled={!cert.file || cert.file.includes("404")}
                  >
                    View Certificate
                  </button>
                  <a
                    href={cert.file || "#"}
                    download={cert.file ? true : false}
                    className={`px-3 py-2 text-white text-sm rounded flex-1 text-center ${
                      cert.file && !cert.file.includes("404")
                        ? "bg-green-600 hover:bg-green-700"
                        : "bg-gray-400 cursor-not-allowed"
                    }`}
                    onClick={(e) => {
                      if (!cert.file || cert.file.includes("404")) {
                        e.preventDefault();
                        alert("Certificate file not available at this time.");
                      }
                    }}
                  >
                    Download

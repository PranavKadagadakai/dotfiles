...
const StudentDashboard = () => {
  ...
  const fetchDashboardData = async () => {
    try {
      const [statsRes, eventsRes, regRes, certRes, txRes] = await Promise.all([
      ...
      // Calculate total approved AICTE points
      const totalPoints = txRes.data.reduce((sum, tx) => {
      ...
      setStats({
        ...statsRes.data,
        total_aicte_points: totalPoints,
      });

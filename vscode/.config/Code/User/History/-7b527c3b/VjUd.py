...
from .views import (
    ...
    # Notifications & Audit
    NotificationViewSet, UserNotificationPreferencesViewSet, AuditLogViewSet,
...
router.register(r'notifications', UserNotificationPreferencesViewSet, basename='notification-preferences')
